-- Fix: COALESCE could not convert type text[] to uuid[]
-- workspaces.member_ids may be uuid[]; legacy accept RPC used text[].
-- workspace_members is the source of truth — drop member_ids update from accept.
